...
public class Track extends MinimalEObjectImpl.Container implements ITrack {
	/**
	 * The cached value of the '{@link #getLanes() <em>Lanes</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLanes()
	 * @generated
	 * @ordered
	...
	public EList<ILane> getLanes() {
		if (lanes == null) {
			lanes = new EObjectContainmentWithInverseEList<>(ILane.class, this, ITimelinePackage.TRACK__LANES, ITimelinePackage.LANE__TRACK);
		}
		return lanes;
	}
